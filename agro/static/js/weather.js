...
const weatherApi = {
    key: 'f251cb2e9055bfa4866a1011d9f7b93a',
...
function changeBg(status) {
    if (status === 'Clouds') {
        document.body.style.backgroundImage = 'url(' + DJANGO_STATIC_URL + 'img/clouds.jpg)';
    } else if (status === 'Rain') {
        document.body.style.backgroundImage = 'url(' + DJANGO_STATIC_URL + 'img/rainy.jpg)';
    } else if (status === 'Clear') {
        document.body.style.backgroundImage = 'url(' + DJANGO_STATIC_URL + 'img/clear.jpg)';
    }
    else if (status === 'Snow') {
        document.body.style.backgroundImage = 'url(' + DJANGO_STATIC_URL + 'img/snow.jpg)';
    }
    else if (status === 'Sunny') {
        document.body.style.backgroundImage = 'url(' + DJANGO_STATIC_URL + 'img/sunny.jpg)';
    } else if (status === 'Thunderstorm') {
        document.body.style.backgroundImage = 'url(' + DJANGO_STATIC_URL + 'img/thunderstrom.jpg)';
    } else if (status === 'Drizzle') {
        document.body.style.backgroundImage = 'url(' + DJANGO_STATIC_URL + 'img/drizzle.jpg)';
    } else if (status === 'Mist' || status === 'Haze' || status === 'Fog') {
        document.body.style.backgroundImage = 'url(' + DJANGO_STATIC_URL + 'img/mist.jpg)';
    }

    else {
        document.body.style.backgroundImage = 'url(' + DJANGO_STATIC_URL + 'img/bg.jpg)';
    }
}
